...
import { Sensor, Sensor_1, Sensor_2, Sensor_3, Sensor_4, Sensor_5, Sensor_6 } from "../../../database/userSchema";
//"../../../../database/userSchema";
...
const end = new Date(`${istDate}T23:59:59.999+05:30`);
  ...
  //const start = new Date(`${selected.toLocaleDateString("en-CA")}T00:00:00+05:30`);
    // END OF DAY
   // const end = new Date(`${selected.toLocaleDateString("en-CA")}T23:59:59.999+05:30`);
